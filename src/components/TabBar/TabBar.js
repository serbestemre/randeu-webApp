      ...
      <Grid item sm={8} xl={10}>
        <div className={classes.root}>
          <AppBar position="static">
            ...
            >
              <Tab label="HİZMET TİPİ" id={"tab1"} aria-controls="aria-tab1"    />
              <Tab label="İŞYERİ TÜRÜ" id={"tab2"} aria-controls="aria-tab2"   />
              <Tab label="İŞYERİ ADI" id={"tab3"} aria-controls="aria-tab3" />
            </Tabs>
          </AppBar>
